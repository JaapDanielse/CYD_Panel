/*
  ...
  V1.0.2 27-04-2026 uniformed externally used enum names to CYD_... , Since %F is available, removed _FString support functions
  V1.0.1 26-04-2026 int and uint32_t supported for slider and graph (value, MaxValue)
  V1.0.0 29-03-2026 Original version
